...
export async function GET(
  ...
  const res = await fetch(`${BASE}/api/v1/developers/${encodeURIComponent(slug)}/comments`, {
...
export async function DELETE(
  ...
  const res = await fetch(
    `${BASE}/api/v1/developers/${encodeURIComponent(slug)}/comments/${encodeURIComponent(id)}`,
